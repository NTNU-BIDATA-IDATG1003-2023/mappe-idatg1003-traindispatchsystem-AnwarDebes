 ...
 * This enum encapsulates different types of removal commands that can be issued,
 * including operations like removing a train number,
 * destination, departure time.
 * Each enum constant is associated with an integer value that represents the specific removal
 * command input.
 *
 * @author Anwar Debes
 * @version 0.0.1
...
public enum RemoveCommands
{
     ...
     */
    RemoveCommands(int removeCommandInput)
    {
